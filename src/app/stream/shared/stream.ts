...
export class StreamComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        var connection = initRTCMultiConnection(null);
        ...
        document.getElementById('open-or-join').onclick = function () {
            var broadcastid = (<HTMLInputElement>document.getElementById('broadcast-id')).value;
            ...
            connection.session = {
                video: (<HTMLInputElement>document.getElementById('broadcast-options')).value.indexOf('Video') !== -1,
                screen: (<HTMLInputElement>document.getElementById('broadcast-options')).value.indexOf('Screen') !== -1,
                audio: (<HTMLInputElement>document.getElementById('broadcast-options')).value.indexOf('Audio') !== -1,
                oneway: true
            };
        ...
        window.onbeforeunload = function () {
            // Firefox is weird!
            (<HTMLInputElement>document.getElementById('open-or-join')).disabled = false;
        };
    }
